...
public class tolist extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        obj=new ArrayAdapter<String>(tolist.this,R.layout.support_simple_spinner_dropdown_item,name);
        ll.setAdapter(obj);
        ll.setOnItemClickListener(
                new AdapterView.OnItemClickListener() {
                    @Override
                    public void onItemClick(AdapterView<?> parent, View view, int p, long id) {
                        ri = (String) ll.getItemAtPosition(p);
                        Intent obj = new Intent(tolist.this, MainActivity.class);
